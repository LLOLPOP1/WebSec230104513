...
<div class="row mt-2">
    ...
    <div class="col col-2 text-end">
        <a href="<?php echo e(route('create_employee')); ?>" class="btn btn-success">Add Employee</a>
    </div>
    <?php endif; ?>
</div>
<form>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\github-lol\WebSec230104513\websec\WebSecService\resources\views/users/list.blade.php ENDPATH**/ ?>